...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="text-align:  center;">
      <asp:Label ID="Label1" runat="server" Text="Agregar Usuario" CssClass="col-md-12 col-sm-12 col-xs-12 text-center" Font-Size="X-Large"></asp:Label>
          </div> 
    <br />
        <div class="row">
    ...
    <br />
    <div class="row">
        <asp:Button ID="Button1" runat="server" Text="Agregar Usuario" CssClass="col-lg-3 col-md-3" style="left:20%"/>
