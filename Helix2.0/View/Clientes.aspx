...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="text-align:  center;">
      ...
      <asp:GridView ID="gvClientes" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="#,NOMBRES,APELLIDOS,Dirección,Telefono,Email,ID_CIUDAD,ID_TIPOINDUSTRIA" DataSourceID="Cliente" OnSelectedIndexChanged="gvClientes_SelectedIndexChanged" Paging="True" CssClass="table table-responsive" HorizontalAlign="Center">
          <Columns>
          ...
          <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="#,Nombre del Cliente,NOMBRES,APELLIDOS,Dirección,Telefono,Email,Tipo de Industria,Ciudad,ID_CIUDAD,ID_TIPOINDUSTRIA" DataSourceID="Consulta" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Paging="True" CssClass="table table-responsive" HorizontalAlign="Center" AllowPaging="True" Visible="False">
          <Columns>
              <asp:BoundField DataField="#" HeaderText="#" InsertVisible="False" ReadOnly="True" SortExpression="#" />
              <asp:BoundField DataField="Nombre del Cliente" HeaderText="Nombre del Cliente" SortExpression="Nombre del Cliente" ReadOnly="True" />
              <asp:BoundField DataField="NOMBRES" HeaderText="NOMBRES" SortExpression="NOMBRES" Visible="False" />
...
INNER JOIN HELIX_TIPO_INDUSTRIA AS Industria ON base.ID_TIPOINDUSTRIA = Industria.ID_TIPOINDUSTRIA WHERE base.APELLIDOS LIKE @nom
          ORDER BY base.APELLIDOS ASC">
         <SelectParameters>
