...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="#,Nombre,Apellido,Cargo,Nombre de Usuario,Contraseña,Telefono,ID_ROL,Email" DataSourceID="Consulta" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CssClass="table table-responsive" AllowPaging="True" Visible="False">
            <Columns>
...
INNER JOIN HELIX_ROL AS Rol ON base.ID_ROL = Rol.ID_ROL
WHERE base.NOMBRE LIKE @nom">
        <SelectParameters>
...
FROM
	HELIX_USUARIO AS base
INNER JOIN HELIX_ROL AS Rol ON base.ID_ROL = Rol.ID_ROL ORDER BY base.APELLIDO ASC"></asp:SqlDataSource>
</asp:Content>
